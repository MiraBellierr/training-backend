...
// You can remove this section as it's already declared above.
...
app.listen(PORT, () => {
  ...
  console.log('');
  console.log('🛒 Protected order endpoints (require auth):');
  console.log(`   POST   http://localhost:${PORT}/api/orders          - multipart/form-data (screenshot, pictures[5], lighburn)`);
  console.log(`   GET    http://localhost:${PORT}/api/orders`);
  console.log(`   GET    http://localhost:${PORT}/api/orders/:id`);
  console.log(`   PUT    http://localhost:${PORT}/api/orders/:id      - multipart/form-data (screenshot, pictures[5], lighburn)`);
  console.log(`   DELETE http://localhost:${PORT}/api/orders/:id`);
  console.log(`   GET    http://localhost:${PORT}/api/orders/:id/files/:type`);
  console.log('='.repeat(50));
});
